...
- Packet 3 immutable photo and voice durability: complete on `packet-3/original-media-durability`, with scoped draft authorization, private D1/R2 receipts, interruption-safe retry, original recording, and protected playback.
