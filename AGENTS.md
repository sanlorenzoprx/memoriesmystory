...
| Production readiness, secrets, CI, or handoff | `docs/EXECUTION/DEFINITION_OF_DONE_V1.md`, `docs/SECURITY/SECRETS_AND_CONFIGURATION.md`, `docs/IMPLEMENTATION/PHASE_1_SOLO_MEMORY_STORY_BUILD_SPEC.md`, `tests/AGENTS.md` | `.github/`, `config/`, `docs/EXECUTION/`, `docs/SECURITY/`, tests |
