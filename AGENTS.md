...
| Muse, transcription, generated descriptions, retrieval, or storyteller-owned context | `docs/FOUNDATION/01_PRODUCT_INVARIANTS.md`, `docs/FOUNDATION/06_AI_BEHAVIOR_GUIDE.md`, `docs/PRODUCT/STORYTELLER_SOVEREIGNTY.md`, `docs/PRODUCT/LIVING_MEMORY_DEFINITION.md` | `app/features/`, `app/domain/`, `app/services/`, tests |
...
4. **Anti-drift:** complete `docs/PRODUCT/LIVING_MEMORY_ANTI_DRIFT_CHECKLIST.md` for material changes.
5. **Change:** make the smallest complete vertical change; preserve validated infrastructure.
6. **Verify:** run proportionate type, lint, unit, integration, build, accessibility, and phone-viewport checks.
7. **Receipt:** record material packet evidence under `docs/IMPLEMENTATION/`.
